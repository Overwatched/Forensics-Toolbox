...
```bash
npm run dist:linux
# AppImage: release/ForensicsToolbox-0.3.AppImage
...
- `ForensicsToolbox-0.3.exe` — portabel Windows
- `ForensicsToolbox-0.3-html.zip` — packa upp och öppna `Toolbox.html` (ingen .exe)
